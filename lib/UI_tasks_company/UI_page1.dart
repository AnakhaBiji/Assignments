...
import 'package:grid_with_card_ui/UI_tasks_company/UI_page2.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              height: 460,
              child: Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgQI5ccJcauW1F2ypgaH-iIqShKWRLl1HKTMuKj31UtVs7xSFU"),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 10, top: 18, bottom: 10),
